    ...
    <>
      ...
      <section className="py-16 sm:py-20">
        <Container className="max-w-4xl">
          <div className="bg-white rounded-3xl shadow-card overflow-hidden">
            <table className="w-full text-left">
              <thead className="bg-brand text-white">
                <tr>
                  <th className="px-6 py-4 text-sm font-semibold">Tujuan (Asal - Tujuan)</th>
                  <th className="px-6 py-4 text-sm font-semibold text-right">Mulai Dari</th>
                </tr>
              </thead>
              <tbody>
                {priceRoutes.map((r, i) => (
                  ...
                  >
                    <td className="px-6 py-4 text-sm font-medium text-brand-deep border-t border-brand-soft/50">
                      {r.from} - {r.to}
                    </td>
                    <td className="px-6 py-4 text-sm font-bold text-brand-deep text-right border-t border-brand-soft/50">
          ...
          <div className="flex items-start gap-3 bg-brand-soft/60 rounded-2xl p-4 mt-6 text-sm text-brand-deep">
